...
HD_PWD='E:/PRG Files/apb_gpio/apb_gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apb_gpio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apb_gpio.tcl
